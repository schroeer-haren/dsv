...
/**
 * Schreibt eine Vereinsergebnisliste und reicht vorbestehende Mängel durch.
 *
 ...
 */
export function writeVereinsergebnislistePreservingDefects(
  records: readonly TypedRecord[],
  options: WriteOptions = {},
): WriteResult {
  return writeTypedListPreservingDefects(records, VEREINSERGEBNISLISTE, options);
}
